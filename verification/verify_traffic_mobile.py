...
def run():
    with sync_playwright() as p:
        ...
        context = browser.new_context(viewport={"width": 375, "height": 667}) # iPhone 8
        ...
        try:
            ...
            page.screenshot(path="verification/traffic_light_mobile.png")
            print("Screenshot saved to verification/traffic_light_mobile.png")
